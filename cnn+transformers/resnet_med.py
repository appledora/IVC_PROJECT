...
def main(data_flag, output_root, num_epochs, gpu_ids, batch_size, download, model_flag, resize, as_rgb, model_path, run):
    ...
    print(log)
    print(f"Log saved at: {os.path.join(output_root, '%s_log.txt' % (data_flag))}")
...
main("octmnist", './output/resnet50', 100, "0", 256, True, 'resnet50', True, True, None, "resnet") # try again with resize false
main("chestmnist", './output/resnet50', 100, "0", 256, True, 'resnet50', True, True, None, "resnet") # try again with resize false
main("pathmnist", './output/resnet50/octmnist', 100, "0", 256, True, 'resnet50', True, True, None, "resnet") # try again with resize false

main("octmnist", './output/resnet18', 100, "0", 256, True, 'resnet18', True, True, None, "resnet") # try again with resize false
main("chestmnist", './output/resnet18', 100, "0", 256, True, 'resnet18', True, True, None, "resnet") # try again with resize false
main("pathmnist", './output/resnet18', 100, "0", 256, True, 'resnet18', True, True, None, "resnet") # try again with resize false